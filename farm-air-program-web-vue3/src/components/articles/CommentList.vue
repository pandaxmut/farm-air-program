<template>
  ...
  <div v-for="item in comments" class="chat-list">
    ...
    <el-row  v-for="childrenItem in item.children" class="chat-item" style="padding-left: 50px">
      <el-col :span="1">
        <el-avatar :src="childrenItem.avatarUrl" style="height: 40px; width: 40px; line-height: 60px; cursor: pointer;" />
      </el-col>
      <el-col :span="23">
...
import  {type ArticleComments} from '@/api/articleComments';
import { insertArticleComments,getArticleComments } from '@/api/articleComments';
// 定义响应式数据
...
onMounted(async () => {
  ...
  //     parentId:null,
  //     articleId:props.id,
  //     commentText:"我是一个前端工程师，喜欢前端，喜欢技术，喜欢生活，喜欢读书，喜欢音乐，喜欢旅行，喜欢运动，喜欢摄影",
